export type Env = {
  ...
  /** Full URL of the Shopify poster preview page (no trailing slash). */
  THEME_POSTER_PREVIEW_PAGE_URL?: string;
  /** Cloudflare R2 bucket for uploaded poster preview images */
